...
export default function Navbar() {
  ...
  return (
    <div>
      <nav id='Navbar' className='fixed top-0 left-0 w-full bg-blue flex flex-wrap justify-between md:items-center text-white px-10 pt-6
      md:px-20'>
      <span className='text-xl font-bold tracking-wide'>Portfolio</span>
      <ul  className={`${menu ? "block":"hidden"}     mx-24 py-2 mt-4 font-semibold md:mt-5 bg-black x-2 rounded-xl
      bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>
       ...
       <a href="#Experience"> <li className='text-md transition-all duration-300 p-1 md:p-0'>Experience</li></a>
        ...
        <a href="#Context"><li className='text-md transition-all duration-300 p-1 md:p-0'>Contents</li></a>
