...
export default function ProjectsCard({title, main}) {
  return (
    ...
    shadow-slate-900 rounded-2xl'>
        <img className='p-2' src={bannerImg} alt="" />
      ...
      <div className='mt-2 p-2 md:p-4 flex gap-2 md:gap-4'>
        ...
        rounded-3xl bg-[#465697]'>Demo</button>
         <button className='md:mt-8 text-white py-2 px-1 text-sm md:text-lg 
        md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold
        rounded-3xl bg-[#465697]'>Source Code</button>
      </div>
    </div>
  )
}
